  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 space-y-6">
      ...
      <div class="text-center space-y-2">
        ...
        <p class="text-sm text-gray-500">Start organizing your tasks today</p>
      </div>
      ...
      <form @submit.prevent="onSubmit" class="space-y-4">
        <div class="space-y-2">
          ...
          <input v-model="name" v-bind="nameAttrs" type="text" placeholder="John Doe"
        ...
        <div class="space-y-2">
          ...
          <input v-model="password" v-bind="passwordAttrs" type="password" placeholder="Create a password"
            class="h-9 w-full rounded-md border px-3 py-1 text-sm" />
